...
const DirectSellingCards = () => {
  ...
  >
    ...
    <div className={`bg-gradient-to-r ${pkg.color} hover:${pkg.hoverColor} p-6 text-white relative overflow-hidden`}>
    ...
    <div className="p-6 pt-0 mt-auto"> {/* Added mt-auto and pt-0 */}
      <button
